...
#if UNITY_EDITOR && ENABLE_COMPACTUI
...
public class UnityEventCompactDrawer : PropertyDrawer
{
    ...
    static readonly GUIContent SearchIcon = EditorGUIUtility.IconContent("Search On Icon");
    ...
    Rect[] GetRowRects(Rect rect)
    {
        ...
        functionRect.xMax -= 27.5f;

        Rect Srect = rect;
        Srect.xMin = functionRect.xMax + Spacing;
